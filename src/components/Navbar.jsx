...
const NavLink = ({ href, children }) => {
  return (
    <a
      href={href}
      className="text-zinc-300 hover:text-yellow-300 transition-colors duration-300"
    >
      {children}
    </a>
  );
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center h-20">
        ...
        {/* Order Now Button */}
        <button className="cursor-hover px-6 py-3 bg-yellow-400 text-black font-bold rounded-lg hover:bg-yellow-300 transition-colors duration-300">
          Order Now
        </button>
      </div>
    </motion.nav>
